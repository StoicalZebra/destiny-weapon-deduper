<template>
  ...
  <div v-if="manifestStore.loading && !manifestStore.isInitialized" class="min-h-screen flex items-center justify-center bg-surface">
    <div class="text-center max-w-md mx-auto px-4">
      ...
      <div class="w-full bg-surface-overlay rounded-full h-2 mb-2">
        <div
